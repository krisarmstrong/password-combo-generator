...
from password_combo_generator import __version__, generate_combinations, generate_permutations, save_passwords, Config
...
def test_generate_permutations():
    ...
    expected = {"ab1", "a1b", "ba1", "b1a", "1ab", "1ba", "Ab1", "A1b", "bA1", "b1A", "1Ab", "1bA"}
...
def test_save_passwords_permission_denied(tmp_path, monkeypatch):
    ...
    tmp_file.touch()
    monkeypatch.setattr("builtins.open", lambda *args, **kwargs: pytest.raises(PermissionError))
